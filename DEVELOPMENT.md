...
```bash
git remote add encore encore://retro-chat-app-3bpi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/retro-chat-app-3bpi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/retro-chat-app-3bpi/settings/integrations/github)
