...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Real-time AI voice filters.",
    tags: ["Filters", "Freemium"]
  },
  {
    name: "Lovo.ai",
    url: "https://lovo.ai",
    description: "Voice generator for creators.",
    tags: ["Creators", "Premium"]
  },
  {
    name: "Murf AI",
    url: "https://murf.ai",
    description: "Voiceovers for business & education.",
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            AI-powered voice generation and audio tools
          </p>
        </div>
