...
const tools: Tool[] = [
  ...
  },
  {
    name: "Scite.ai",
    url: "https://scite.ai",
    description: "Smart citation & fact-checking.",
    tags: ["Citations", "Premium"]
  },
  {
    name: "Socratic",
    url: "https://socratic.org",
    description: "AI for school questions.",
    tags: ["School", "Free"]
  },
  {
    name: "Diffit",
    url: "https://diffit.me",
    description: "Adapt learning materials with AI.",
    tags: ["Adaptive", "Freemium"]
  },
  {
    name: "Mindgrasp",
    url: "https://mindgrasp.ai",
    description: "Learn from PDFs & lectures faster.",
    tags: ["Study", "Premium"]
  }
];
